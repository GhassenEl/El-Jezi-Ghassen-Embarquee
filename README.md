...
Espace de projets simples autour du **système embarqué** : RTOS, Linux embarqué, affichage de données et **mobile Flutter IoT**.
...
| `04-mobile-flutter/` | Mobile IoT | `sensor_dashboard`, `ble_scanner`, `iot_remote` | Android / iOS (Flutter) |
...
- **Flutter** : [Flutter SDK](https://docs.flutter.dev/get-started/install) 3.16+
...
# Mobile Flutter
cd 04-mobile-flutter/sensor_dashboard
flutter pub get && flutter run
```

## Auteur

**Ghassen El Jezi** — projets pédagogiques embarqué (RTOS, Linux, IHM data, Flutter IoT).
