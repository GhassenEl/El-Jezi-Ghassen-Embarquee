#!/usr/bin/env python3
"""Moniteur MQTT Smart Home — El Jezi Ghassen."""
...
def parse_args() -> argparse.Namespace:
  p = argparse.ArgumentParser(description="Moniteur Smart Home El Jezi")
  p.add_argument("--broker", default="localhost")
  p.add_argument("--port", type=int, default=1883)
  p.add_argument("--temp-alert", type=float, default=30.0)
...
def on_message(client, userdata, msg):
  ...
  if temp > userdata["temp_alert"]:
    print(f"  ! Temperature elevee {temp}°C")
  if m.group("motion") == "1":
